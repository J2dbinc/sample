...
{
	unsigned char keyCipher[KEY_SZ];
	...
	memcpy(keyCipher, "012345678901234567890123456789012", sizeof(iv));
	memcpy(iv, "012345678901234567890123456789012", sizeof(iv));
	...
	const EVP_CIPHER *pCipher = EVP_get_cipherbyname("aes-256-cbc");
